...
-- --------------------------------------------------
-- Date Created: 04/15/2014 21:52:42
...
CREATE TABLE [dbo].[IPictureSet_Reward] (
    ...
    [RewardSponsorGuid] uniqueidentifier  NOT NULL,
    [Guid] uniqueidentifier  NOT NULL
);
GO
...
-- Creating foreign key on [RewardSponsorGuid] in table 'IPictureSet_Reward'
ALTER TABLE [dbo].[IPictureSet_Reward]
ADD CONSTRAINT [FK_RewardSponsorReward]
    FOREIGN KEY ([RewardSponsorGuid])
