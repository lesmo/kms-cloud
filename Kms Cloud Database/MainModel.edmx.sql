...
-- --------------------------------------------------
-- Date Created: 04/27/2014 14:36:49
-- Generated from EDMX file: F:\KMS Invent\KMS Cloud\Kms Cloud Database\MainModel.edmx
-- --------------------------------------------------
...
-- Creating table 'IPictureSet_UserPicture'
CREATE TABLE [dbo].[IPictureSet_UserPicture] (
    [Guid] uniqueidentifier  NOT NULL,
    [User_Guid] uniqueidentifier  NOT NULL
);
GO
...
-- Creating primary key on [Guid] in table 'IPictureSet_UserPicture'
ALTER TABLE [dbo].[IPictureSet_UserPicture]
ADD CONSTRAINT [PK_IPictureSet_UserPicture]
    PRIMARY KEY CLUSTERED ([Guid] ASC);
GO
...
-- Creating foreign key on [User_Guid] in table 'IPictureSet_UserPicture'
ALTER TABLE [dbo].[IPictureSet_UserPicture]
ADD CONSTRAINT [FK_UserPictureUser]
    FOREIGN KEY ([User_Guid])
    REFERENCES [dbo].[UserSet]
        ([Guid])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_UserPictureUser'
CREATE INDEX [IX_FK_UserPictureUser]
ON [dbo].[IPictureSet_UserPicture]
    ([User_Guid]);
GO
...
-- Creating foreign key on [Guid] in table 'IPictureSet_UserPicture'
ALTER TABLE [dbo].[IPictureSet_UserPicture]
ADD CONSTRAINT [FK_UserPicture_inherits_IPicture]
    FOREIGN KEY ([Guid])
    REFERENCES [dbo].[IPictureSet]
        ([Guid])
    ON DELETE CASCADE ON UPDATE NO ACTION;
