...
;function getKMS_ajaxUri(a){return sprintf("%s//%s/%s/DynamicResources/Ajax/%s",location.protocol,location.host,$("html").attr("lang"),a)}function setKMS_userPicture(){$("#Usuario input[type=file]").trigger("click")}$(function(){var a=$("#Usuario input[type=file]");$("#Usuario input[type=file]").change(function(){if(a.val().length<1)return;a.parent().trigger("submit")})})
;$(function(){$("#sidebar").height($("#contenidos").height())})
